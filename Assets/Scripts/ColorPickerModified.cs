...
namespace Microsoft.MixedReality.Toolkit.Experimental.ColorPicker
{
    ...
    /// </summary>
    public class ColorPickerModified : MonoBehaviour, IMixedRealityTouchHandler
    {
        private bool active;
        ...
        private Material targetObjectTexture;
        [Experimental]
        [SerializeField]
        ...
        /// <summary>
        /// This will set the visibility, scale, and position of the color picker while extracting the color of the touched object's MeshRenderer
        /// </summary>
